...
The deployment publication trigger now explicitly opts into the tenant scope
...
The application change in open-hax/knoxx#305 validates a closed scope and requires
...
logic. Deploy this declaration with the reviewed runtime that implements it.
